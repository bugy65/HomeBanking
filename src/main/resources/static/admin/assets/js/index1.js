Vue.createApp({
    ...
    methods: {
        login() {
            ...
            ).then(response => location.href= "http://localhost:8080/web/dashboard.html").then(response => console.log('signed in!!!'))
        ...
        Register() {
            ...
            ).then(response => location.href= "http://localhost:8080/web/dashboard.html"))
